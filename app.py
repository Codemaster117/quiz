    ...
    if Question.query.count() == 0:
        demo = [
            ...
            Question(question_text="La familia de Paulo reconoce algo bueno de el.",
                     ...
                     correct_answer="B"),
            Question(question_text="Chela Sentia algo raren en Niki",
                     question_type="TF",
                     option_a="Verdadero", option_b="Falso",
                     correct_answer="A"),
            Question(question_text="Dante y Ari eran insoportables",
                     question_type="TF",
                     option_a="Verdadero", option_b="Falso",
                     correct_answer="A"),
            Question(question_text="Niki perdio un año en otro liceo por fallas",
                     question_type="TF",
                     option_a="Verdadero", option_b="Falso",
                     correct_answer="A"),
            Question(question_text="Los papas de Niki no se separaron despues de varios argumentos sobre cambiar su vida",
                     question_type="TF",
                     option_a="Verdadero", option_b="Falso",
                     correct_answer="B"),
