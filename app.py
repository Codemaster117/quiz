    ...
    if Question.query.count() == 0:
        demo = [
            ...
            Question(question_text="Que significa el DMA",
                     question_type="MCQ",
                     option_a="Decalogo Mejores Amigas", option_b="Diez Maneras de matar Abejas", option_c="Dialecto mejores amistades", option_d="Diagrama mejores Amistades",
                     correct_answer="A"),
            Question(question_text="Que rol cumple ",
                     question_type="MCQ",
                     option_a="Decalogo Mejores Amigas", option_b="Diez Maneras de matar Abejas", option_c="Dialecto mejores amistades", option_d="Diagrama mejores Amistades",
                     correct_answer="A"),
            # True/False
